...
packages=("python3" "python3-dev" "python3-pip" "net-tools" "hostapd" "dnsmasq" "jq" "network-manager-openconnect" "openconnect" "openssl")
...
python3 "$this_dir_path/../web/manage.py" process_tasks>/tmp/app-task.log 2>/tmp/app-task.log.error &
