...
packages=("python3" "python3-dev" "python3-pip" "net-tools" "hostapd" "dnsmasq" "jq" "openconnect" "openssl" "redsocks")
...
nohup python3 "$this_dir_path/../web/manage.py" runserver 0.0.0.0:80 1>/tmp/app-web.log 2>/tmp/app-web.log.error &
