    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interface', models.CharField(max_length=16, unique=True, validators=[superclient.setting.models.DhcpServerConfig_validate_interface])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interface', models.CharField(max_length=16, unique=True, validators=[superclient.setting.models.HotspotConfig_validate_interface])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interface', models.CharField(max_length=16, unique=True, validators=[superclient.setting.models.LanConfig_validate_interface])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interface', models.CharField(max_length=16, unique=True, validators=[superclient.setting.models.WlanConfig_validate_interface])),
                ('ssid', models.CharField(max_length=128)),
                ('wpa_passphrase', models.CharField(max_length=128)),
                ('driver', models.CharField(choices=[('nl80211', 'nl80211'), ('wext', 'wext'), ('nl80211,wext', 'nl80211,wext')], default='nl80211,wext', max_length=128)),
                ('dhcp', models.BooleanField(default=True)),
                ('ip_address_1', models.CharField(blank=True, max_length=16)),
                ('subnet_mask_1', models.CharField(blank=True, max_length=16)),
                ('ip_address_2', models.CharField(blank=True, max_length=16)),
