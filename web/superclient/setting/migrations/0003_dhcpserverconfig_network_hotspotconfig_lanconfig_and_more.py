# Generated by Django 4.1.1 on 2022-11-27 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ssid', models.CharField(max_length=128)),
                ('wpa_passphrase', models.CharField(max_length=128)),
                ('mode', models.CharField(choices=[('dhcp', 'DHCP'), ('static', 'STATIC')], default='dhcp', max_length=16)),
                ('ip_address', models.CharField(blank=True, max_length=16)),
                ('subnet_mask', models.CharField(blank=True, max_length=16)),
            ],
            bases=('setting.network',),
        ),
    ]
