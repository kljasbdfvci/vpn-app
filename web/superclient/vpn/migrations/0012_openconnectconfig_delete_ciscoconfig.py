...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('configuration_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='vpn.configuration')),
                ('protocol', models.CharField(choices=[('anyconnect', 'Cisco (AnyConnect)'), ('nc', 'Juniper Network Connect'), ('gp', 'Palo Alto Networks (PAN) GlobalProtect VPN'), ('pulse', 'Junos Pulse VPN'), ('f5', 'F5 Big-IP VPN'), ('fortinet', 'Fortinet Fortigate VPN'), ('array', 'Array Networks SSL VPN')], default='anyconnect', max_length=128)),
